...
// RSVP section: attendance + gift registry copy
export function Rsvp() {
  ...
  return (
    <section id="rsvp" className="section-container relative overflow-hidden py-stack-lg fade-in-up">
      <BotanicalFrame />
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        {!submitted ? (
          <form
            ...
            className="bg-white/30 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-outline-variant/30 space-y-5 fade-up"
          >
            <div>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {[
                  { value: 'hadir', label: 'Saya akan hadir', icon: Check },
                  { value: 'tidak', label: 'Maaf, tidak bisa hadir', icon: Users },
                ].map((opt) => {
                  const Icon = opt.icon
                  return (
                    <button
          ...
          <div className="bg-white/30 backdrop-blur-sm rounded-xl p-8 border border-outline-variant/30 text-center fade-up">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4">
              <Check size={32} className="text-primary" />
            </div>
            <h3 className="font-display text-headline-sm text-primary mb-2 italic">
              Terima Kasih
            </h3>
        ...
        <div className="mt-12">
          <div className="text-center mb-6">
            ...
            <h3 className="font-display text-headline-sm text-primary italic">
              Hadiah Pernikahan
            </h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {/* Bank */}
            <div className="bg-white/30 backdrop-blur-sm rounded-xl p-6 border border-outline-variant/30 fade-up delay-100">
            ...
            {/* eWallet */}
            <div className="bg-white/30 backdrop-blur-sm rounded-xl p-6 border border-outline-variant/30 fade-up delay-200">
              <p className="font-label-caps text-label-caps text-tertiary uppercase tracking-wider mb-3">
                e-Wallet
              </p>
              <p className="font-display text-headline-sm text-primary mb-1">
        ...
        <div className="text-center mt-12">
          <Sparkles size={32} className="text-primary mx-auto mb-3 opacity-70" />
          <p className="font-display text-headline-sm text-primary italic">
            Bambang &amp; Imroatus
          </p>
